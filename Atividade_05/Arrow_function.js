...
const alunos = ["Maria", "Ana", "Gabriel"];
const busca = alunos.find(nome => nome === "Ana");
console.log(busca);
...
const nomes = ["ana", "clara"];
const maiusculas = nomes.map (n => n.toUpperCase());
nomes.forEach (n => console.log (n.toUpperCase()));
nomes.map (n => n.toLowerCase()).forEach (n => console.log(n));

// .startsWith() .endsWith() -> retorna quem começa/quem termina...
